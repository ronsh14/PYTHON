...
from module23.integrating_tools.model import Developer
...
proj_description = st.text_area("Project Developer")
...
if st.button("Create Project"):
    ...
    response = requests.post("http://localhost:8501/developers/", json=proj_data)
    st.json(response.json())
